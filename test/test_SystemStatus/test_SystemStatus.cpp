...
void test_constructor_withJsonDocument() {
    ...
    doc[SYSTEM_STATUS_FIELD_LAST_PERSISTENT_STORAGE_FAILED_TIMESTAMP] = UnixTimeWithMilliSeconds(50,
                                                                                                 100).toJsonDocument();
    doc[SYSTEM_STATUS_FIELD_LAST_STATUS_TIMESTAMP] = UnixTimeWithMilliSeconds(500, 100).toJsonDocument();
...
void test_toJsonDocument() {
    ...
    TEST_ASSERT_EQUAL(500, doc[SYSTEM_STATUS_FIELD_LAST_STATUS_TIMESTAMP][UNIX_TIME_FIELD_SECONDS]);
